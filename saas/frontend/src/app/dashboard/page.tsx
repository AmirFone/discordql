    ...
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="premium-card p-6 rounded-2xl">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs text-ink-500 uppercase tracking-wider">Storage</span>
          </div>
          <div className="mb-2">
            <span className="font-display text-3xl font-bold text-ink-800">
              {usage?.storage_used_mb.toFixed(1)}
            </span>
            <span className="text-ink-500 text-sm ml-1">MB</span>
          </div>
          <div className="relative h-2 bg-surface-300 rounded-full overflow-hidden mb-2">
            <div
        ...
        <div className="premium-card p-6 rounded-2xl">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs text-ink-500 uppercase tracking-wider">Queries</span>
          </div>
          <div className="mb-2">
            <span className="font-display text-3xl font-bold text-ink-800">
        ...
        <div className="premium-card p-6 rounded-2xl">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs text-ink-500 uppercase tracking-wider">Extractions</span>
          </div>
          <div className="mb-2">
            <span className="font-display text-3xl font-bold text-ink-800">
      ...
      <div className="premium-card p-6 rounded-2xl">
        <div className="flex items-center justify-between mb-6">
          <h2 className="font-display text-xl font-semibold text-ink-800">Bot Connection</h2>
          <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-sm ${
            ...
            <span className={`w-2 h-2 rounded-full ${
              botStatus?.connected ? "bg-green-500 animate-pulse" : "bg-ink-400"
            }`} />
        ...
        {botStatus?.connected ? (
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-medium text-ink-800">{botStatus.guild_name}</p>
          ...
          <div className="text-center py-8">
            ...
            <p className="text-ink-600 mb-4">No Discord bot connected yet</p>
            <Link
              href="/dashboard/bot"
      ...
      {/* Quick Actions */}
      <div>
        <h2 className="font-display text-xl font-semibold text-ink-800 mb-4">Quick Actions</h2>
        <div className="grid md:grid-cols-3 gap-4">
          {[
            ...
            <Link
              key={i}
              href={action.href}
              className="premium-card p-5 rounded-xl flex items-center gap-4 hover:border-gold-400/50 transition-all duration-200 group"
            >
              <div className="w-12 h-12 rounded-xl bg-surface-200 border border-surface-400 flex items-center justify-center text-ink-500 group-hover:bg-gold-400/15 group-hover:border-gold-400/30 group-hover:text-gold-600 transition-colors">
                {action.icon}
              </div>
              <div>
                <p className="font-medium text-ink-800 group-hover:text-gold-600 transition-colors">
                  {action.label}
                </p>
